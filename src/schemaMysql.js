...
var MysqlDatabase = /** @class */ (function () {
    ...
    MysqlDatabase.getEnumNameFromColumn = function (tableName, columnName) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.queryAsync('SELECT table_name, column_name, column_type, data_type ' +
                    ...
                    case 1:
                        ...
                        rawEnumRecords.forEach(function (enumItem) {
                            var enumName = MysqlDatabase.getEnumNameFromColumn(enumItem.table_name, enumItem.column_name);
